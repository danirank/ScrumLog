...
namespace ScrumLog.API.Data
{
    ...
    public partial class IntitialMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DailyMeetingEntries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MeetingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PersonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Yesterday = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Today = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Blockers = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyMeetingEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyMeetingEntries_Meetings_MeetingId",
                        column: x => x.MeetingId,
                        principalTable: "Meetings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DailyMeetingEntries_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMeetingEntries_MeetingId",
                table: "DailyMeetingEntries",
                column: "MeetingId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyMeetingEntries_PersonId",
                table: "DailyMeetingEntries",
                column: "PersonId");
